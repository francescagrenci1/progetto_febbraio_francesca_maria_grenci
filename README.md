...
Il progetto consiste nello scrivere una funzione che verifichi la validità dell'encoding FAME di una determinata molecola data, analizzando sia la sua correttezza sintattica sia quella relativa alla valenza dei singoli atomi e legami.
